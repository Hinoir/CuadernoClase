...
public class SingupActivity extends AppCompatActivity {
    ...
    private EditText et_singup_telefono;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_singup_telefono = findViewById(R.id.et_signup_telefono);
                ...
                if(pass.equals(repass)){
                    ...
                    auth.createUserWithEmailAndPassword(correo, pass).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            ...
                            Usuario usuario = new Usuario(uid,et_singup_nombre.getText().toString(),
                                    et_singup_telefono.getText().toString(),
                                    correo,
                                    pass);
