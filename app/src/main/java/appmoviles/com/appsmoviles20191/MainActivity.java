...
public class MainActivity extends AppCompatActivity implements AdapterAmigos.onItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //rtdb.getReference().child("alfa").child("beta").child("gama").setValue("mi primer valorS");
    ...
    protected void onResume() {
        super.onResume();
        adapterAmigos.showAllAmigos(localdb.getAllAmigos(auth.getCurrentUser().getUid()));
    }
